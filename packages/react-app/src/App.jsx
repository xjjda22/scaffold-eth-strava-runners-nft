...
function App(props) {
  ...
  const faucetTx = Transactor(userProvider, gasPrice);
      ...
      <BrowserRouter>
        ...
        <Switch>
          ...
          <Route path="/ipfsup">
            ...
            {showBroswerRouter && <div style={{ padding: 16, paddingBottom: 150 }}>{ipfsHash}</div>}

            {showBroswerRouter && (
              <div style={{ paddingTop: 10, width: 740, margin: "auto" }}>
                <Input
                  value={ipfsDownHash}
