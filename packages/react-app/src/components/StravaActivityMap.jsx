    ...
    <div style={{ margin: "auto", marginTop: 10, padding: 10 }}>
      <div style={{ margin: "auto", marginTop: 10 }}>
        <Steps size="small" direction="vertical">
          ...
          <Step title="Mint NFT" description="mint the nft on kovan testnet" status={"process"} />
          <Step title="View NFT on opensea" description="view and trade NFT on opensea" status={"process"} />
          <Step title="TODO - create video or gif" description="" status={"process"} />
          <Step title="TODO - create pixelated version" description="" status={"process"} />
          <Step title="TODO - create postcard version" description="" status={"process"} />
        </Steps>
      </div>
      <Space align="center"
