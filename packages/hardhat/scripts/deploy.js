...
const main = async () => {
  ...
  const YourChallenge = await deploy("YourChallenge"); // <-- add in constructor args like line 19 vvvv
  
  // await YourChallenge.challenge("0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266","0x70997970c51812dc3a010c7d01b50e0d17dc79c8", "1","2", "5");
  // await YourChallenge.stake({value: ethers.utils.parseEther("10")});
